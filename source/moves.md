...
***Mega Drain** Grass-type Special Move*: +5 to hit, d4+SpAtk damage. User recovers half the HP inflicted on opponent.
...
***Toxic** Poison-type Status Move*: +4 to hit, badly poisons opponent.
...
***Bide** Normal-type Physical Move*: User takes damage for two turns then strikes back double.
...
***Cut** Normal-type Physical Move*: +4 to hit, d4+Atk damage. 
...
***Egg Bomb** Normal-type Physical Move*: +2 to hit, d10+Atk damage. 

***Explosion** Normal-type Physical Move*: +5 to hit, d20+Atk damage. User faints.

***Flash** Normal-type Status Move*: +5 to hit, lowers opponent's Accuracy.
...
***Mimic** Normal-type Status Move*: Copies the opponent's last move.
...
***Soft-Boiled** Normal-type Status Move*: User recovers half its max HP.
...
***Strength** Normal-type Physical Move*: +5 to hit, d8+Atk damage. 

***Struggle** Normal-type Physical Move*: d4+Atk damage. Only usable when all PP are gone. Hurts the user.
...
***Fissure** Ground-type Physical Move*: -2 to hit, one-Hit-KO, if it hits.
...
***Surf** Water-type Special Move*: +5 to hit, d8+SpAtk damage. Hits all adjacent Pokémon.
...
***Fly** Flying-type Physical Move*: +4 to hit, d8+Atk damage. Flies up on first turn, attacks on second turn.
...
***Fire Blast** Fire-type Special Move*: +3 to hit, d10+SpAtk damage. On a hit above 18 will burn opponent.
...
***Rock Slide** Rock-type Physical Move*: +4 to hit, d8+Atk damage. On a hit above 18 will cause flinching.
